      ...
      <div className="row">
        <div className="col-md-10 col-lg-8">
          <div
            ...
            data-cue="fadeIn"
          >
            <div className="flex-shrink-0 d-inline-block w-20 h-2px bg-primary-gradient" />
            <span className="d-block fw-medium text-light fs-20">
              How Thoota Maths Helps You
            </span>
          </div>
          <h2 className="text-light" data-cue="fadeIn">
            Experience The Full Power of Math Learning
          </h2>
          <p className="text-light mb-0 max-text-11" data-cue="fadeIn">
            Thoota makes math learning accessible and engaging with voice-powered lessons, simplifying complex concepts for all levels.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row g-4" data-cues="fadeIn">
      <div className="col-md-6">
        <div className="process-card rounded-5 p-6 p-xl-10">
          ...
          <h5 className="text-light process-card__title">Personalized Math Tutoring</h5>
          <p className="mb-8">
            There are many variations of passage available, but the majority
            have suffered words which don't look even slightly believable.
          </p>
          <a
      ...
      <div className="col-md-6">
        <div className="process-card rounded-5 p-6 p-xl-10">
          ...
          <h5 className="text-light process-card__title">Interactive Math Support</h5>
          <p className="mb-8">
            Get real-time assistance with math problems through Thoota's interactive voice and chat features.
          </p>
          <a
            className="btn process-card__btn text-white fs-14 border-0 rounded-pill"
            href="/contact"
